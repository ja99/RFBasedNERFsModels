...
def normal_train():
    ...
    PATH = "FullyEncodedPerAntenna_logs"
...
def render():
    ...
    model = FullyEndToEnd.load_from_checkpoint(
        "FullyEncodedPerAntenna_logs/beamforming_2024-03-14 15:17:11.173033/epoch=38-step=15795.ckpt"
    )
    model = model.cuda()
...
if __name__ == "__main__":
    ...
    # normal_train()
    render()
# tensorboard --logdir FullyEncodedPerAntenna_logs
